...
interface Props {
  ...
  open: boolean;
  onCloseClicked: () => void;
  onSave: (value: TermsAndServicesConfig) => void;
}

export function EditTermsAndServicesConfigDialog({
  defaultValue,
  open,
  onCloseClicked,
  onSave,
  ...
  return (
    ...
    >
      <DialogContent>
        <FormProvider
          id="edit-terms-and-services-config-form"
          methods={methods}
          onSubmit={onSubmit}
        >
      ...
      <DialogActions>
        <BaseButton
          ...
          variant="contained"
          type="submit"
          form="edit-terms-and-services-config-form"
        >
          Save
        </BaseButton>
      </DialogActions>
