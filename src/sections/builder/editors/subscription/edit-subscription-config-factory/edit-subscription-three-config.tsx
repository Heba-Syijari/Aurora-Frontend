...
import { SubscriptionThreeConfig } from 'src/sections/builder/components/subscription/types';
...
export interface EditSubscriptionThreeConfigProps {
  defaultValue: SubscriptionThreeConfig;
  onSave: (value: SubscriptionThreeConfig) => void;
  theme: Theme;
  onCloseClicked: () => void;
}

export default function EditSubscriptionThreeConfig({
  defaultValue,
  onSave,
  onCloseClicked,
  theme,
}: EditSubscriptionThreeConfigProps) {
  ...
  const methods = useForm({
    resolver: yupResolver<SubscriptionThreeConfig>(schema),
    defaultValues,
  });
