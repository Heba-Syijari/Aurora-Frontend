...
import { SubscriptionSixConfig } from 'src/sections/builder/components/subscription/types';
...
export interface EditSubscriptionSixConfigProps {
  defaultValue: SubscriptionSixConfig;
  onSave: (value: SubscriptionSixConfig) => void;
  theme: Theme;
  onCloseClicked: () => void;
}

export default function EditSubscriptionSixConfig({
  defaultValue,
  onSave,
  onCloseClicked,
  theme,
}: EditSubscriptionSixConfigProps) {
  ...
  const methods = useForm({ resolver: yupResolver<SubscriptionSixConfig>(schema), defaultValues });
