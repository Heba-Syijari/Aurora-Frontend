...
import { SubscriptionFiveConfig } from 'src/sections/builder/components/subscription/types';
...
export interface EditSubscriptionFiveConfigProps {
  defaultValue: SubscriptionFiveConfig;
  onSave: (value: SubscriptionFiveConfig) => void;
  theme: Theme;
  onCloseClicked: () => void;
}

export default function EditSubscriptionFiveConfig({
  defaultValue,
  onSave,
  onCloseClicked,
  theme,
}: EditSubscriptionFiveConfigProps) {
  ...
  const methods = useForm({ resolver: yupResolver<SubscriptionFiveConfig>(schema), defaultValues });
