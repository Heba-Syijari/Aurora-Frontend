...
interface Props {
  ...
  open: boolean;
  onCloseClicked: () => void;
  onSave: (value: CopyWriteConfig) => void;
}

export function EditCopyWriteConfigDialog({ defaultValue, open, onCloseClicked, onSave }: Props) {
  ...
  return (
    ...
    >
      <DialogContent>
        <FormProvider id="edit-copy-write-config-form" methods={methods} onSubmit={onSubmit}>
      ...
      <DialogActions>
        <BaseButton
          ...
          variant="contained"
          type="submit"
          form="edit-copy-write-config-form"
        >
          Save
        </BaseButton>
      </DialogActions>
