...
import { AboutComponentName, AboutSevenConfig } from 'src/sections/builder/components/about/types';
...
export interface EditAboutSevenConfigProps {
  defaultValue: AboutSevenConfig;
  onSave: (value: AboutSevenConfig) => void;
  theme: Theme;
  onCloseClicked: () => void;
...
export default function aboutEditConfig({
  ...
  // eslint-disable-next-line react-hooks/rules-of-hooks
  const methods = useForm({ resolver: yupResolver<AboutSevenConfig>(schema), defaultValues });
