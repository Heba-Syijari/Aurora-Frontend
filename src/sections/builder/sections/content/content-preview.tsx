...
export default function ContentPreview({ children, previewWidth, pageId }: Props) {
          ...
          <BuilderThemeProvider fontFamily={settings.fontFamily} palette={settings.palette}>
            ...
            {/* <FooterOne
              data={{
                ...
                logoType: settings.logoType,
                logoValue: settings.logoValue,
                backgroundColor: 'secondary.main', // 'common.white' | 'secondary.main'
                textColor: 'common.white', // 'text.primary' | 'common.white'
              }}
            /> */}
